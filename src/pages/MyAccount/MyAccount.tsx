...
import SidebarSettings from "@/components/ui/SidebarSettings";
    ...
    <div>
      ...
      <div className="flex px-20">
        ...
        <div className="grow py-8">
          <div className="grid grid-cols-2 w-full gap-7">
                ...
                <div className="flex gap-5 items-center">
                  ...
                  <div className="flex flex-col items-start gap-2">
                    <p>
                      ...
                      <span className="text-[#D0FD00]">|</span>{" "}
                      <span className="text-[#D4D4D4]">John Doe</span>
                    </p>
            ...
            <div className="flex flex-col justify-between rounded-3xl p-7 bg-[#151617]">
              <div className="flex flex-col gap-2">
                <p className="text-3xl text-[#D0FD00] font-bold">Rp 273.000</p>
          ...
          <div className="mt-7">
            <p className="font-bold text-2xl mb-5">Total Transaksi</p>
